<div class="container">
  <h1 class="mb-4 pb-2">Welcome to Shades of Green</h1>
  <div id="odd" class="row">
    <div class="col-lg-9">
      <p>
        Many people want to be able to live more sustainiable live.
      </p>
      <p>
  ...
  <div id="even" class="row">
    <div class="col-lg-9">
      <p>
        Or you can individually browse all the different options of eco housing.
      </p>
    </div>
    <div class="col-lg-3">
